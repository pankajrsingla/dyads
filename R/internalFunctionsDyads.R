...
b2modelB2ML1lb <- function (nets, actor = NULL , density = NULL, center = NULL, densVar = NULL) 
{
  current.na.action <- options('na.action')
  options(na.action='na.pass')
  nnets <- length(nets)
  net <- blockMatrixDiagonal(nets)
  #if (nnets==1 | densVar==FALSE) {nrandd <- 0} else {nrandd <- nnets}
  if (nnets==1) {nrandd <- 0; densVar <- FALSE} else {nrandd <- nnets}
  ...
  return(list(y=y, X=X, X1=X1, X2=X2, X3=X3, yl=yl, Xl=Xl, X3l=X3l, X4l=X4l, XS=XS, XRE=XRE, nrows=n, nact=nactsum, netnums=netnums, nactnets=nact, ns=ns, nre=nre, nd=nd, nr=nr, nrandd= nrandd, nrandr=nrandr, densVar=densVar))
  options(na.action='current.na.action')
}
...
modelMLB19lb <- function (nets, sender = NULL, receiver = NULL , density = NULL, reciprocity = NULL, center = NULL, densVar = NULL, recVar = NULL) 
{
  current.na.action <- options('na.action')
  options(na.action='na.pass')
  zeroC <- FALSE
  nnets <- length(nets)
  net <- blockMatrixDiagonal(nets)
  if (nnets==1) {nrandd <- 0; nrandr <- 0; densVar <- FALSE; recVar <- FALSE} else {nrandd <- nnets; nrandr <- nnets}
  # if (densVar == FALSE) {nrandd <- 0} else {nrandd <- nnets}
  # if (recVar == FALSE) {nrandr <- 0} else {nrandr <- nnets}
  # if (nnets == 1) {nrandd <- 0; nrandr <- 0} 
  # if (densVar == TRUE){overalld <- 1} else {overalld <- 0}
  # if (recVar == TRUE){overallr <- 1} else {overallr <- 0}
  if (densVar == TRUE | nnets == 1){overalld <- 1} else {overalld <- 0}
  ...
  # Hier gaar het mis: nr wordt 5 ipv 4, waarschijnlijk door de ~1
  if(!is.null(reciprocity) & (reciprocity != ~1)){
    if (recVar == TRUE | nnets == 1){
      nr <- 1+ nrandr+ ((dim(model.matrix(reciprocity))[2]-1)/maxact)
      X4 <- matrix(rep(0, nsum*nr), ncol=nr)
      X4[,1] <- 1
    } else {
  ...
  return(list(y=y, X=X, X1=X1, X2=X2, X3=X3, X4=X4, yl=yl, Xl=Xl, X3l=X3l, X4l=X4l, XS=XS, XRE=XRE, nrows=n, nact=nactsum, netnums=netnums, nactnets=nact, ns=ns, nre=nre, nd=nd, nr=nr, nrandd=nrandd, nrandr=nrandr, densVar=densVar, recVar=recVar))
  options(na.action='current.na.action')
}
...
lGlm <- function(par, sdPar){
  return(log(exp(par/(2*sdPar))/(1+exp(par/sdPar))))
}

# log Gelman likelihood mu
lGlr <- function(par, sdPar){
  return(log(exp(par/(sdPar))/(16*(1+exp(par/(2*sdPar)))^4)))
}
...
summary.b2MLb <- function(object, ...){
  if (object$densVar == TRUE) {object$drandd <- 1} else {object$drandd <- 0}
  MCMCsims <- object$MCMCsims[ , c(1, if (object$drandd>0) 1+object$drandd, 
                                   if (object$ns>0) {(1+object$drandd+1):(1+object$drandd+object$ns)},
                                   if (object$densVar == TRUE | object$nnets == 1) {1+object$drandd+object$ns+object$nre+1} else {(1+object$drandd+object$ns+object$nre+1):(1+object$drandd+object$ns+object$nre+object$nrandd)}, 
                                   if (object$nd>0) {if (object$densVar == TRUE | object$nnets == 1) {(1+object$drandd+object$ns+object$nre+object$nrandd+2):(1+object$drandd+object$ns+object$nre+object$nrandd+1+object$nd)} else {(1+object$drandd+object$ns+object$nre+object$nrandd+1):(1+object$drandd+object$ns+object$nre+object$nrandd+object$nd)}})]
  output.matrix <- matrix(NA, dim(MCMCsims)[2], 10)
  colnames(output.matrix) <- c("Estimate", "SE", "Q.5", "Q2.5", "Q25", "Q50", "Q75", "Q97.5", "Q99.5", "Neff")
  rownames(output.matrix) <- colnames(MCMCsims)
  output.matrix[,1] <- colMeans(MCMCsims, na.rm = T) 
...
summary.2ML <- function(object, ...){
  MCMCsims <- object$MCMCsims[ , c(1:3, if (object$drandd>0) 3+object$drandd, if (object$drandr>0) 3+object$drandd+object$drandr, 
                              ...
                              if (object$densVar == TRUE | object$nnets == 1) {3+object$drandd+object$drandr+object$ns+object$nre+1} else {(3+object$drandd+object$drandr+object$ns+object$nre+1):(3+object$drandd+object$drandr+object$ns+object$nre+object$nrandd)}, 
                              if (object$nd>0) {if (object$densVar == TRUE | object$nnets == 1) {(3+object$drandd+object$drandr+object$ns+object$nre+object$nrandd+2):(3+object$drandd+object$drandr+object$ns+object$nre+object$nrandd+1+object$nd)} else {(3+object$drandd+object$drandr+object$ns+object$nre+object$nrandd+1):(3+object$drandd+object$drandr+object$ns+object$nre+object$nrandd+object$nd)}},
                              ...
                              if (object$nr>0) {if (object$densVar == TRUE | object$nnets == 1) {(3+object$drandd+object$drandr+object$ns+object$nre+object$nrandd+object$nd+object$nrandr+3):(3+object$drandd+object$drandr+object$ns+object$nre+object$nrandd+object$nd+object$nrandr+object$nr+2)}
...
summary.2MLb <- function(object, ...){
  if (object$densVar == TRUE) {object$drandd <- 1} else {object$drandd <- 0}
  if (object$recVar == TRUE) {object$drandr <- 1} else {object$drandr <- 0}
  MCMCsims <- object$MCMCsims[ , c(1:3, if (object$drandd>0) 3+object$drandd, if (object$drandr>0) 3+object$drandd+object$drandr, 
                                   if (object$ns>0) {(3+object$drandd+object$drandr+1):(3+object$drandd+object$drandr+object$ns)}, 
                                   if (object$nre>0) {(3+object$drandd+object$drandr+object$ns+1):(3+object$drandd+object$drandr+object$ns+object$nre)},
                                   if (object$densVar == TRUE | object$nnets == 1) {3+object$drandd+object$drandr+object$ns+object$nre+1} else {(3+object$drandd+object$drandr+object$ns+object$nre+1):(3+object$drandd+object$drandr+object$ns+object$nre+object$nrandd)}, 
                                   if (object$nd>0) {if (object$densVar == TRUE | object$nnets == 1) {(3+object$drandd+object$drandr+object$ns+object$nre+object$nrandd+2):(3+object$drandd+object$drandr+object$ns+object$nre+object$nrandd+1+object$nd)} else {(3+object$drandd+object$drandr+object$ns+object$nre+object$nrandd+1):(3+object$drandd+object$drandr+object$ns+object$nre+object$nrandd+object$nd)}},
                                   if (object$recVar == TRUE | object$nnets == 1) {3+object$drandd+object$drandr+object$ns+object$nre+object$nrandd+object$nd+2} else {(3+object$drandd+object$drandr+object$ns+object$nre+object$nrandd+object$nd+1):(3+object$drandd+object$drandr+object$ns+object$nre+object$nrandd+object$nd+object$nrandr)},
                                   if (object$nr>0) {if (object$recVar == TRUE | object$nnets == 1) {(3+object$drandd+object$drandr+object$ns+object$nre+object$nrandd+object$nd+object$nrandr+3):(3+object$drandd+object$drandr+object$ns+object$nre+object$nrandd+object$nd+object$nrandr+object$nr+2)}
                                     else {(3+object$drandd+object$drandr+object$ns+object$nre+object$nrandd+object$nd+object$nrandr+1):(3+object$drandd+object$drandr+object$ns+object$nre+object$nrandd+object$nd+object$nrandr+object$nr)}})]
  output.matrix <- matrix(NA, dim(MCMCsims)[2], 10)
  colnames(output.matrix) <- c("Estimate", "SE", "Q.5", "Q2.5", "Q25", "Q50", "Q75", "Q97.5", "Q99.5", "Neff")
  rownames(output.matrix) <- colnames(MCMCsims)
